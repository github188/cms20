...
public class RealEventDTO extends BaseDTO {
	List<Event> eventReals = new LinkedList<Event>();

	public List<Event> getEventReals() {
		return eventReals;
	}

	public void setEventReals(List<Event> eventReals) {
		this.eventReals = eventReals;
	}
