package com.scsvision.cms.util.string;
...
public class MyStringUtil {
	 ...
	 *         Create at 2013-6-18 下午3:23:20
	 */
	public static List<String> getAttributeValues(String[] array, String key) {
	 ...
	 * @param className
	 *            对象名称
	 * @return 单词间以下划线间隔的数据表名称
	 * @author MIKE
	 *         <p />
	 *         Create at 2015 下午3:52:26
	 */
